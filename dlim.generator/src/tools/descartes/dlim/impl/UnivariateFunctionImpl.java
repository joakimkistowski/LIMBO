 ...
 * <ul>
 * <li>{@link tools.descartes.dlim.impl.UnivariateFunctionImpl#getFunction <em>
 * Function</em>}</li>
 * </ul>
 * </p>
 *
	...
	public NotificationChain basicSetFunction(Function newFunction,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					DlimPackage.UNIVARIATE_FUNCTION__FUNCTION, oldFunction,
					newFunction);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setFunction(Function newFunction) {
		if (newFunction != function) {
			...
			if (function != null)
				msgs = ((InternalEObject) function).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- DlimPackage.UNIVARIATE_FUNCTION__FUNCTION,
						null, msgs);
			if (newFunction != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.UNIVARIATE_FUNCTION__FUNCTION, newFunction,
					newFunction));
	}
