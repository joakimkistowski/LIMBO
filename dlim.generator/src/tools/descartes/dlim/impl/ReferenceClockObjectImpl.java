 ...
 * <ul>
 * <li>{@link tools.descartes.dlim.impl.ReferenceClockObjectImpl#getName <em>
 * Name</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.ReferenceClockObjectImpl#getLoopTime
 * <em>Loop Time</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.ReferenceClockObjectImpl#getSeqTime <em>
 * Seq Time</em>}</li>
 * </ul>
 * </p>
 *
...
public class ReferenceClockObjectImpl extends MinimalEObjectImpl.Container
	...
	/**
	 * The default value of the '{@link #getLoopTime() <em>Loop Time</em>}'
	...
	/**
	 * The cached value of the '{@link #getLoopTime() <em>Loop Time</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLoopTime()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getSeqTime() <em>Seq Time</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getSeqTime()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getSeqTime() <em>Seq Time</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getSeqTime()
	 * @generated
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.REFERENCE_CLOCK_OBJECT__NAME, oldName, name));
	}
	...
	public void setLoopTime(double newLoopTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.REFERENCE_CLOCK_OBJECT__LOOP_TIME, oldLoopTime,
					loopTime));
	}
	...
	public void setSeqTime(double newSeqTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.REFERENCE_CLOCK_OBJECT__SEQ_TIME, oldSeqTime,
					seqTime));
	}
