 ...
 * <li>{@link tools.descartes.dlim.impl.NormalNoiseImpl#getStandardDeviation
...
public class NormalNoiseImpl extends NoiseImpl implements NormalNoise {
	...
	public void setMean(double newMean) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.NORMAL_NOISE__MEAN, oldMean, mean));
	}
	...
	public void setStandardDeviation(double newStandardDeviation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.NORMAL_NOISE__STANDARD_DEVIATION,
