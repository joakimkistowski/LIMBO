 ...
 * <ul>
 * <li>
 * {@link tools.descartes.dlim.impl.TimeDependentFunctionContainerImpl#getName
 * <em>Name</em>}</li>
 * <li>
 * {@link tools.descartes.dlim.impl.TimeDependentFunctionContainerImpl#getDuration
 * <em>Duration</em>}</li>
 * <li>
 * {@link tools.descartes.dlim.impl.TimeDependentFunctionContainerImpl#getFirstIterationStart
 * <em>First Iteration Start</em>}</li>
 * <li>
 * {@link tools.descartes.dlim.impl.TimeDependentFunctionContainerImpl#getFirstIterationEnd
 * <em>First Iteration End</em>}</li>
 * <li>
 * {@link tools.descartes.dlim.impl.TimeDependentFunctionContainerImpl#getFunction
 * <em>Function</em>}</li>
 * <li>
 * {@link tools.descartes.dlim.impl.TimeDependentFunctionContainerImpl#getPointOfReferenceClockObject
 * <em>Point Of Reference Clock Object</em>}</li>
 * <li>
 * {@link tools.descartes.dlim.impl.TimeDependentFunctionContainerImpl#getPointOfReferenceClockType
 * <em>Point Of Reference Clock Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TimeDependentFunctionContainerImpl extends
	...
	/**
	 * The cached value of the '{@link #getPointOfReferenceClockObject()
	 * <em>Point Of Reference Clock Object</em>}' reference. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The default value of the '{@link #getPointOfReferenceClockType()
	 * <em>Point Of Reference Clock Type</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getPointOfReferenceClockType()
	 * <em>Point Of Reference Clock Type</em>}' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @see #getPointOfReferenceClockType()
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__NAME,
					oldName, name));
	}
	...
	public void setDuration(double newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__DURATION,
	...
	public void setFirstIterationStart(double newFirstIterationStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__FIRST_ITERATION_START,
	...
	public void setFirstIterationEnd(double newFirstIterationEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__FIRST_ITERATION_END,
	...
	public NotificationChain basicSetFunction(Function newFunction,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__FUNCTION,
			...
			if (function != null)
				msgs = ((InternalEObject) function)
						.eInverseRemove(
								...
								null, msgs);
			if (newFunction != null)
				msgs = ((InternalEObject) newFunction)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__FUNCTION,
	...
	public ReferenceClockObject getPointOfReferenceClockObject() {
		if (pointOfReferenceClockObject != null
				&& pointOfReferenceClockObject.eIsProxy()) {
			...
			if (pointOfReferenceClockObject != oldPointOfReferenceClockObject) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							...
							DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__POINT_OF_REFERENCE_CLOCK_OBJECT,
							oldPointOfReferenceClockObject,
	...
	public void setPointOfReferenceClockObject(
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					...
					Notification.SET,
					DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__POINT_OF_REFERENCE_CLOCK_OBJECT,
					oldPointOfReferenceClockObject, pointOfReferenceClockObject));
	}
	...
	public void setPointOfReferenceClockType(
		...
		pointOfReferenceClockType = newPointOfReferenceClockType == null ? POINT_OF_REFERENCE_CLOCK_TYPE_EDEFAULT
				: newPointOfReferenceClockType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__POINT_OF_REFERENCE_CLOCK_TYPE,
					oldPointOfReferenceClockType, pointOfReferenceClockType));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER__POINT_OF_REFERENCE_CLOCK_OBJECT:
			if (resolve)
				return getPointOfReferenceClockObject();
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER___DURATION_GREATER_ZERO__DIAGNOSTICCHAIN_MAP:
			return durationGreaterZero((DiagnosticChain) arguments.get(0),
					(Map<?, ?>) arguments.get(1));
		case DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER___REFERENCE_CLOCK_IN_TREE_NODE__DIAGNOSTICCHAIN_MAP:
			return referenceClockInTreeNode((DiagnosticChain) arguments.get(0),
					(Map<?, ?>) arguments.get(1));
		}
