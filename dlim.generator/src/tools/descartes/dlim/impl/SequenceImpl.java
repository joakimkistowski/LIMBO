 ...
 * <li>{@link tools.descartes.dlim.impl.SequenceImpl#getTerminateAfterTime <em>
 * Terminate After Time</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.SequenceImpl#getReferenceClock <em>
 * Reference Clock</em>}</li>
 * <li>
 * {@link tools.descartes.dlim.impl.SequenceImpl#getSequenceFunctionContainers
 * <em>Sequence Function Containers</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.SequenceImpl#getTerminateAfterLoops <em>
 * Terminate After Loops</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.SequenceImpl#getFirstIterationStart <em>
 * First Iteration Start</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.SequenceImpl#getFirstIterationEnd <em>
 * First Iteration End</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.SequenceImpl#getLoopDuration <em>Loop
 * Duration</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.SequenceImpl#getFinalDuration <em>Final
 * Duration</em>}</li>
 * </ul>
 * </p>
 *
...
public class SequenceImpl extends FunctionImpl implements Sequence {
	...
	/**
	 * The default value of the '{@link #getTerminateAfterTime()
	...
	/**
	 * The cached value of the '{@link #getTerminateAfterTime()
	 * <em>Terminate After Time</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getTerminateAfterTime()
	...
	/**
	 * The cached value of the '{@link #getReferenceClock()
	...
	/**
	 * The default value of the '{@link #getTerminateAfterLoops()
	...
	/**
	 * The cached value of the '{@link #getTerminateAfterLoops()
	 * <em>Terminate After Loops</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getTerminateAfterLoops()
	...
	/**
	 * The default value of the '{@link #getFirstIterationStart()
	...
	/**
	 * The cached value of the '{@link #getFirstIterationStart()
	 * <em>First Iteration Start</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getFirstIterationStart()
	...
	/**
	 * The default value of the '{@link #getFirstIterationEnd()
	...
	/**
	 * The cached value of the '{@link #getFirstIterationEnd()
	 * <em>First Iteration End</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getFirstIterationEnd()
	...
	/**
	 * The default value of the '{@link #getLoopDuration()
	...
	/**
	 * The cached value of the '{@link #getLoopDuration()
	 * <em>Loop Duration</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getLoopDuration()
	...
	/**
	 * The default value of the '{@link #getFinalDuration()
	...
	/**
	 * The cached value of the '{@link #getFinalDuration()
	 * <em>Final Duration</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getFinalDuration()
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.SEQUENCE__NAME, oldName, name));
	}
	...
	public void setTerminateAfterTime(double newTerminateAfterTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.SEQUENCE__TERMINATE_AFTER_TIME,
					oldTerminateAfterTime, terminateAfterTime));
	}
	...
	public NotificationChain basicSetReferenceClock(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, DlimPackage.SEQUENCE__REFERENCE_CLOCK,
					oldReferenceClock, newReferenceClock);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setReferenceClock(ReferenceClockObject newReferenceClock) {
		if (newReferenceClock != referenceClock) {
			...
			if (referenceClock != null)
				msgs = ((InternalEObject) referenceClock).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- DlimPackage.SEQUENCE__REFERENCE_CLOCK, null,
						msgs);
			if (newReferenceClock != null)
				msgs = ((InternalEObject) newReferenceClock).eInverseAdd(this,
						EOPPOSITE_FEATURE_BASE
								- DlimPackage.SEQUENCE__REFERENCE_CLOCK, null,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.SEQUENCE__REFERENCE_CLOCK, newReferenceClock,
					newReferenceClock));
	}
	...
	public EList<TimeDependentFunctionContainer> getSequenceFunctionContainers() {
		if (sequenceFunctionContainers == null) {
			sequenceFunctionContainers = new EObjectContainmentEList<TimeDependentFunctionContainer>(
					TimeDependentFunctionContainer.class, this,
					DlimPackage.SEQUENCE__SEQUENCE_FUNCTION_CONTAINERS);
		}
	...
	public void setTerminateAfterLoops(int newTerminateAfterLoops) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.SEQUENCE__TERMINATE_AFTER_LOOPS,
					oldTerminateAfterLoops, terminateAfterLoops));
	}
	...
	public void setFirstIterationStart(double newFirstIterationStart) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.SEQUENCE__FIRST_ITERATION_START,
					oldFirstIterationStart, firstIterationStart));
	}
	...
	public void setFirstIterationEnd(double newFirstIterationEnd) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.SEQUENCE__FIRST_ITERATION_END,
					oldFirstIterationEnd, firstIterationEnd));
	}
	...
	public void setLoopDuration(double newLoopDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.SEQUENCE__LOOP_DURATION, oldLoopDuration,
					loopDuration));
	}
	...
	public void setFinalDuration(double newFinalDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.SEQUENCE__FINAL_DURATION, oldFinalDuration,
					finalDuration));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case DlimPackage.SEQUENCE__SEQUENCE_FUNCTION_CONTAINERS:
			return ((InternalEList<?>) getSequenceFunctionContainers())
	...
	public void eSet(int featureID, Object newValue) {
		...
		case DlimPackage.SEQUENCE__SEQUENCE_FUNCTION_CONTAINERS:
			...
			getSequenceFunctionContainers()
					.addAll((Collection<? extends TimeDependentFunctionContainer>) newValue);
			return;
		case DlimPackage.SEQUENCE__TERMINATE_AFTER_LOOPS:
	...
	public boolean eIsSet(int featureID) {
		...
		case DlimPackage.SEQUENCE__SEQUENCE_FUNCTION_CONTAINERS:
			return sequenceFunctionContainers != null
					&& !sequenceFunctionContainers.isEmpty();
		case DlimPackage.SEQUENCE__TERMINATE_AFTER_LOOPS:
	...
	public Object eInvoke(int operationID, EList<?> arguments)
		...
		case DlimPackage.SEQUENCE___DURATION_DEFINED__DIAGNOSTICCHAIN_MAP:
			return durationDefined((DiagnosticChain) arguments.get(0),
					(Map<?, ?>) arguments.get(1));
		}
