 ...
 * <ul>
 * <li>{@link tools.descartes.dlim.impl.PolynomialFactorImpl#getFactor <em>
 * Factor</em>}</li>
 * <li>{@link tools.descartes.dlim.impl.PolynomialFactorImpl#getOffset <em>
 * Offset</em>}</li>
 * </ul>
 * </p>
 *
...
public class PolynomialFactorImpl extends MinimalEObjectImpl.Container
	...
	/**
	 * The default value of the '{@link #getFactor() <em>Factor</em>}'
	...
	public void setFactor(double newFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.POLYNOMIAL_FACTOR__FACTOR, oldFactor, factor));
	}
	...
	public void setOffset(double newOffset) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					DlimPackage.POLYNOMIAL_FACTOR__OFFSET, oldOffset, offset));
	}
