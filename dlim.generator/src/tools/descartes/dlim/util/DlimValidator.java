...
public class DlimValidator extends EObjectValidator {
	 ...
	 * constraint 'Duration Defined' of 'Sequence'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for
	 * constraint 'Duration Greater Zero' of 'Time Dependent Function
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for
	 * constraint 'Reference Clock In Tree Node' of 'Time Dependent Function
	 * Container'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for
	 * constraint 'Peak Time Greater Zero' of 'Burst'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	protected boolean validate(int classifierID, Object value,
		...
		case DlimPackage.TIME_DEPENDENT_FUNCTION_CONTAINER:
			return validateTimeDependentFunctionContainer(
					(TimeDependentFunctionContainer) value, diagnostics,
					context);
		...
		case DlimPackage.UNIFORM_NOISE:
			return validateUniformNoise((UniformNoise) value, diagnostics,
					context);
		case DlimPackage.NORMAL_NOISE:
			return validateNormalNoise((NormalNoise) value, diagnostics,
					context);
		...
		case DlimPackage.EXPONENTIAL_INCREASE_AND_DECLINE:
			return validateExponentialIncreaseAndDecline(
					(ExponentialIncreaseAndDecline) value, diagnostics, context);
		case DlimPackage.EXPONENTIAL_INCREASE_LOGARITHMIC_DECLINE:
			return validateExponentialIncreaseLogarithmicDecline(
					(ExponentialIncreaseLogarithmicDecline) value, diagnostics,
					context);
		case DlimPackage.LINEAR_INCREASE_AND_DECLINE:
			return validateLinearIncreaseAndDecline(
					(LinearIncreaseAndDecline) value, diagnostics, context);
		case DlimPackage.ABSOLUTE_SIN:
			return validateAbsoluteSin((AbsoluteSin) value, diagnostics,
					context);
		case DlimPackage.LINEAR_TREND:
			return validateLinearTrend((LinearTrend) value, diagnostics,
					context);
		case DlimPackage.EXPONENTIAL_TREND:
			return validateExponentialTrend((ExponentialTrend) value,
					diagnostics, context);
		case DlimPackage.LOGARITHMIC_TREND:
			return validateLogarithmicTrend((LogarithmicTrend) value,
					diagnostics, context);
		...
		case DlimPackage.REFERENCE_CLOCK_OBJECT:
			return validateReferenceClockObject((ReferenceClockObject) value,
					diagnostics, context);
		case DlimPackage.ARRIVAL_RATES_FROM_FILE:
			return validateArrivalRatesFromFile((ArrivalRatesFromFile) value,
					diagnostics, context);
		case DlimPackage.ABSOLUTE_VALUE_FUNCTION:
			return validateAbsoluteValueFunction((AbsoluteValueFunction) value,
					diagnostics, context);
		case DlimPackage.UNIVARIATE_FUNCTION:
			return validateUnivariateFunction((UnivariateFunction) value,
					diagnostics, context);
		...
		case DlimPackage.POLYNOMIAL_FACTOR:
			return validatePolynomialFactor((PolynomialFactor) value,
					diagnostics, context);
	...
	public boolean validateSequence(Sequence sequence,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(sequence, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(sequence,
				diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(sequence, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(sequence, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_EveryBidirectionalReferenceIsPaired(sequence,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(sequence, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(sequence, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(sequence, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(sequence, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validateSequence_durationDefined(sequence, diagnostics,
					context);
		return result;
	}
	...
	public boolean validateTimeDependentFunctionContainer(
			...
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(timeDependentFunctionContainer,
				diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(
				timeDependentFunctionContainer, diagnostics, context);
		if (result || diagnostics != null)
		...
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(
					timeDependentFunctionContainer, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(timeDependentFunctionContainer,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(timeDependentFunctionContainer,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(
					timeDependentFunctionContainer, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateTimeDependentFunctionContainer_durationGreaterZero(
					timeDependentFunctionContainer, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateTimeDependentFunctionContainer_referenceClockInTreeNode(
					timeDependentFunctionContainer, diagnostics, context);
		return result;
	}

	/**
	 * Validates the durationGreaterZero constraint of '
	...
	public boolean validateTimeDependentFunctionContainer_durationGreaterZero(
			TimeDependentFunctionContainer timeDependentFunctionContainer,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return timeDependentFunctionContainer.durationGreaterZero(diagnostics,
				context);
	}

	/**
	 * Validates the referenceClockInTreeNode constraint of '
	 * <em>Time Dependent Function Container</em>'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	...
	public boolean validateTimeDependentFunctionContainer_referenceClockInTreeNode(
			TimeDependentFunctionContainer timeDependentFunctionContainer,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return timeDependentFunctionContainer.referenceClockInTreeNode(
				diagnostics, context);
	}
	...
	public boolean validateUniformNoise(UniformNoise uniformNoise,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(uniformNoise, diagnostics,
				context);
	}
	...
	public boolean validateNormalNoise(NormalNoise normalNoise,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(normalNoise, diagnostics,
				context);
	}
	...
	public boolean validateBurst(Burst burst, DiagnosticChain diagnostics,
			Map<Object, Object> context) {
		if (!validate_NoCircularContainment(burst, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(burst, diagnostics,
				context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(burst, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(burst, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_EveryBidirectionalReferenceIsPaired(burst,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(burst, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(burst, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(burst, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(burst, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateBurst_peakTimeGreaterZero(burst, diagnostics,
					context);
		return result;
	}
	...
	public boolean validateExponentialIncreaseAndDecline(
			...
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(exponentialIncreaseAndDecline,
				diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(
				exponentialIncreaseAndDecline, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(
					exponentialIncreaseAndDecline, diagnostics, context);
		if (result || diagnostics != null)
		...
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(
					exponentialIncreaseAndDecline, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(exponentialIncreaseAndDecline,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(exponentialIncreaseAndDecline,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(
					exponentialIncreaseAndDecline, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateBurst_peakTimeGreaterZero(
					exponentialIncreaseAndDecline, diagnostics, context);
		return result;
	}
	...
	public boolean validateExponentialIncreaseLogarithmicDecline(
		...
		if (!validate_NoCircularContainment(
				exponentialIncreaseLogarithmicDecline, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(
				exponentialIncreaseLogarithmicDecline, diagnostics, context);
		if (result || diagnostics != null)
		...
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(
					exponentialIncreaseLogarithmicDecline, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(exponentialIncreaseLogarithmicDecline,
					diagnostics, context);
		if (result || diagnostics != null)
	...
	public boolean validateLinearIncreaseAndDecline(
			...
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(linearIncreaseAndDecline,
				diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(
				linearIncreaseAndDecline, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(linearIncreaseAndDecline,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(
					linearIncreaseAndDecline, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryBidirectionalReferenceIsPaired(
					linearIncreaseAndDecline, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(linearIncreaseAndDecline,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(linearIncreaseAndDecline, diagnostics,
					context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(linearIncreaseAndDecline,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(linearIncreaseAndDecline,
					diagnostics, context);
		if (result || diagnostics != null)
			result &= validateBurst_peakTimeGreaterZero(
					linearIncreaseAndDecline, diagnostics, context);
	...
	public boolean validateAbsoluteSin(AbsoluteSin absoluteSin,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(absoluteSin, diagnostics,
				context);
	}
	...
	public boolean validateLinearTrend(LinearTrend linearTrend,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(linearTrend, diagnostics,
				context);
	}
	...
	public boolean validateExponentialTrend(ExponentialTrend exponentialTrend,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(exponentialTrend, diagnostics,
				context);
	}
	...
	public boolean validateLogarithmicTrend(LogarithmicTrend logarithmicTrend,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(logarithmicTrend, diagnostics,
				context);
	}
	...
	public boolean validateReferenceClockObject(
			...
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(referenceClockObject,
				diagnostics, context);
	}
	...
	public boolean validateArrivalRatesFromFile(
			...
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(arrivalRatesFromFile,
				diagnostics, context);
	}
	...
	public boolean validateAbsoluteValueFunction(
			...
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(absoluteValueFunction,
				diagnostics, context);
	}
	...
	public boolean validateUnivariateFunction(
			...
			Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(univariateFunction, diagnostics,
				context);
	}
	...
	public boolean validatePolynomialFactor(PolynomialFactor polynomialFactor,
			DiagnosticChain diagnostics, Map<Object, Object> context) {
		return validate_EveryDefaultConstraint(polynomialFactor, diagnostics,
				context);
	}
