...
public class DlimItemProviderAdapterFactory extends DlimAdapterFactory
	 ...
	 * {@link tools.descartes.dlim.Sequence} instances. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.Combinator} instances. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.TimeDependentFunctionContainer} instances.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createTimeDependentFunctionContainerAdapter() {
		if (timeDependentFunctionContainerItemProvider == null) {
			timeDependentFunctionContainerItemProvider = new TimeDependentFunctionContainerItemProvider(
					this);
		}
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.UniformNoise} instances. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.NormalNoise} instances. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.Constant} instances. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.Sin} instances. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.ExponentialIncreaseAndDecline} instances.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createExponentialIncreaseAndDeclineAdapter() {
		if (exponentialIncreaseAndDeclineItemProvider == null) {
			exponentialIncreaseAndDeclineItemProvider = new ExponentialIncreaseAndDeclineItemProvider(
					this);
		}
	...
	public Adapter createExponentialIncreaseLogarithmicDeclineAdapter() {
		if (exponentialIncreaseLogarithmicDeclineItemProvider == null) {
			exponentialIncreaseLogarithmicDeclineItemProvider = new ExponentialIncreaseLogarithmicDeclineItemProvider(
					this);
		}
	...
	public Adapter createLinearIncreaseAndDeclineAdapter() {
		if (linearIncreaseAndDeclineItemProvider == null) {
			linearIncreaseAndDeclineItemProvider = new LinearIncreaseAndDeclineItemProvider(
					this);
		}
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.AbsoluteSin} instances. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.LinearTrend} instances. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a
	 * {@link tools.descartes.dlim.ExponentialTrend}. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createExponentialTrendAdapter() {
		if (exponentialTrendItemProvider == null) {
			exponentialTrendItemProvider = new ExponentialTrendItemProvider(
					this);
		}
	...
	/**
	 * This creates an adapter for a
	 * {@link tools.descartes.dlim.LogarithmicTrend}. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createLogarithmicTrendAdapter() {
		if (logarithmicTrendItemProvider == null) {
			logarithmicTrendItemProvider = new LogarithmicTrendItemProvider(
					this);
		}
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.SinTrend} instances. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a
	 * {@link tools.descartes.dlim.ReferenceClockObject}. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createReferenceClockObjectAdapter() {
		if (referenceClockObjectItemProvider == null) {
			referenceClockObjectItemProvider = new ReferenceClockObjectItemProvider(
					this);
		}
	...
	/**
	 * This creates an adapter for a
	 * {@link tools.descartes.dlim.ArrivalRatesFromFile}. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createArrivalRatesFromFileAdapter() {
		if (arrivalRatesFromFileItemProvider == null) {
			arrivalRatesFromFileItemProvider = new ArrivalRatesFromFileItemProvider(
					this);
		}
	...
	/**
	 * This creates an adapter for a
	 * {@link tools.descartes.dlim.AbsoluteValueFunction}. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createAbsoluteValueFunctionAdapter() {
		if (absoluteValueFunctionItemProvider == null) {
			absoluteValueFunctionItemProvider = new AbsoluteValueFunctionItemProvider(
					this);
		}
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link tools.descartes.dlim.Polynomial} instances. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createPolynomialFactorAdapter() {
		if (polynomialFactorItemProvider == null) {
			polynomialFactorItemProvider = new PolynomialFactorItemProvider(
					this);
		}
	...
	public void dispose() {
		...
		if (combinatorItemProvider != null)
			combinatorItemProvider.dispose();
		if (timeDependentFunctionContainerItemProvider != null)
			timeDependentFunctionContainerItemProvider.dispose();
		if (uniformNoiseItemProvider != null)
			uniformNoiseItemProvider.dispose();
		if (normalNoiseItemProvider != null)
			normalNoiseItemProvider.dispose();
		if (constantItemProvider != null)
			constantItemProvider.dispose();
		if (sinItemProvider != null)
			sinItemProvider.dispose();
		if (exponentialIncreaseAndDeclineItemProvider != null)
			exponentialIncreaseAndDeclineItemProvider.dispose();
		if (exponentialIncreaseLogarithmicDeclineItemProvider != null)
			exponentialIncreaseLogarithmicDeclineItemProvider.dispose();
		if (linearIncreaseAndDeclineItemProvider != null)
			linearIncreaseAndDeclineItemProvider.dispose();
		if (absoluteSinItemProvider != null)
			absoluteSinItemProvider.dispose();
		if (linearTrendItemProvider != null)
			linearTrendItemProvider.dispose();
		if (exponentialTrendItemProvider != null)
			exponentialTrendItemProvider.dispose();
		if (logarithmicTrendItemProvider != null)
			logarithmicTrendItemProvider.dispose();
		if (sinTrendItemProvider != null)
			sinTrendItemProvider.dispose();
		if (referenceClockObjectItemProvider != null)
			referenceClockObjectItemProvider.dispose();
		if (arrivalRatesFromFileItemProvider != null)
			arrivalRatesFromFileItemProvider.dispose();
		if (absoluteValueFunctionItemProvider != null)
			absoluteValueFunctionItemProvider.dispose();
		if (polynomialItemProvider != null)
			polynomialItemProvider.dispose();
		if (polynomialFactorItemProvider != null)
			polynomialFactorItemProvider.dispose();
	}
