...
/**
 * This is the item provider adapter for a {@link tools.descartes.dlim.Trend}
...
public class TrendItemProvider extends FunctionItemProvider {
	...
	protected void addFunctionOutputAtStartPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Trend_functionOutputAtStart_feature",
						"_UI_Trend_type"),
				DlimPackage.Literals.TREND__FUNCTION_OUTPUT_AT_START, true,
	...
	protected void addFunctionOutputAtEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Trend_functionOutputAtEnd_feature",
						"_UI_Trend_type"),
				DlimPackage.Literals.TREND__FUNCTION_OUTPUT_AT_END, true,
				false, false, ItemPropertyDescriptor.REAL_VALUE_IMAGE, null,
				null));
	}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Trend_type") + " "
